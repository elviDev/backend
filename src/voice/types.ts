...
// Additional types for Multi-Action Execution System
...
export interface ExecutionSummary {
  ...
  actionBreakdown: Record<string, { success: number; failed: number; avgTime: number }>;
}

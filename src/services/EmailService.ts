...
If you didn't create an account with us, please ignore this email.
  ...
  async sendVerificationLinkResend(data: EmailVerificationData): Promise<boolean> {
    const verificationUrl = `${this.frontendUrl}/verify-email/${data.verificationToken}`;
...
If you continue to receive unwanted password reset emails, please contact support immediately.
  ...
  async sendChannelMemberAdded(data: ChannelMemberData): Promise<boolean> {
...
The CEO Communication Platform Team
  ...
  async sendTaskAssigned(data: TaskAssignmentData): Promise<boolean> {
...
The CEO Communication Platform Team
  ...
  async sendTaskStatusChanged(data: TaskStatusChangeData): Promise<boolean> {
    const tasksUrl = `${this.frontendUrl}/tasks`;

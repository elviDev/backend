...
async function testThreadAPI() {
    try {
        ...
        const channelResult = await (0, database_1.query)('SELECT id FROM channels LIMIT 1');
        const threadResult = await (0, database_1.query)(`
    ...
    `);
        ...
        const rootResult = await (0, database_1.query)(`
    ...
    `, [threadReply.id]);
        ...
        const repliesResult = await (0, database_1.query)(`
      SELECT 
        m.id,
        m.content,
        m.user_id,
    ...
    `, [threadRootId]);
        ...
        logger_1.logger.error('Thread API test failed:', error);
        throw error;
    }
}
...
exports.default = testThreadAPI;
//# sourceMappingURL=test-thread-api.js.map
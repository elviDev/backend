...
async function checkThreads() {
    try {
        ...
        const messagesResult = await (0, database_1.query)(`
      SELECT 
        m.id,
        m.content,
        m.reply_to_id,
    ...
    `);
        ...
        if (firstThread) {
            ...
            console.log('==============================');
            const threadReplies = await (0, database_1.query)(`
        SELECT 
          m.id,
          m.content,
          m.reply_to_id,
      ...
      `, [firstThread]);
        ...
        logger_1.logger.error('Thread check failed:', error);
        throw error;
    }
}
...
exports.default = checkThreads;
//# sourceMappingURL=check-threads.js.map
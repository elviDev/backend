...
exports.checkAndClearAccountStatus = checkAndClearAccountStatus;
...
async function checkAndClearAccountStatus() {
    try {
        ...
        logger_1.logger.info('🔍 Checking CEO account status...');
    ...
    `);
      ...
      `);
        ...
        logger_1.logger.error('❌ Failed to check account status:', error);
        throw error;
    }
}
...
//# sourceMappingURL=check-account-status.js.map